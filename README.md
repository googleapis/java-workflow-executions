...
The Maven artifact coordinates (`com.google.cloud:google-cloud-workflow-executions`) remain the same.
...
```Groovy
implementation 'com.google.cloud:google-cloud-workflow-executions:2.12.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-workflow-executions" % "2.12.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-workflow-executions/2.12.0
