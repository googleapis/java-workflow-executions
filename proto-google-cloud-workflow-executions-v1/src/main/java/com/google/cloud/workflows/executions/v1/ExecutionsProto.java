...
public final class ExecutionsProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "5google/cloud/workflows/executions/v1/executions.proto\022$google.cloud.workflows."
          + "executions.v1\032\034google/api/annotations.pr"
          + "oto\032\027google/api/client.proto\032\037google/api"
          + "/field_behavior.proto\032\031google/api/resource.proto\032\037google/protobuf/timestamp.proto\"\237"
          + "\t\n"
          + "\tExecution\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\0223\n\n"
          + "start_time\030\002 \001(\0132\032.google.protobuf.TimestampB\003\340A\003\0221\n"
          + "\010end_time\030\003 \001(\0132\032.google.protobuf.TimestampB\003\340A\003\022I\n"
          + "\005state\030\004"
          + " \001(\01625.google.cloud.workflows.executions.v1.Execution.StateB\003\340A\003\022\020\n"
          + "\010argument\030\005 \001(\t\022\023\n"
          + "\006result\030\006 \001(\tB\003\340A\003\022I\n"
          + "\005error\030\007"
          + " \001(\01325.google.cloud.workflows.executions.v1.Execution.ErrorB\003\340A\003\022!\n"
          + "\024workflow_revision_id\030\010 \001(\tB\003\340A\003\022T\n"
          + "\016call_log_level\030\t"
          + " \001(\0162<.google.cloud.workflows.executions.v1.Execution.CallLogLevel\032\312\001\n"
          + "\021StackTraceElement\022\014\n"
          + "\004step\030\001 \001(\t\022\017\n"
          + "\007routine\030\002 \001(\t\022\\\n"
          + "\010position\030\003"
          + " \001(\0132J.google.cloud.workflows.executions.v1.Execution.StackTraceElement.Position\0328\n"
          + "\010Position\022\014\n"
          ...
          + "StackTrace\022S\n"
          + "\010elements\030\001"
          + " \003(\0132A.google.cloud.workflows.executions.v1.Execution.StackTraceElement\032z\n"
          + "\005Error\022\017\n"
          + "\007payload\030\001 \001(\t\022\017\n"
          + "\007context\030\002 \001(\t\022O\n"
          + "\013stack_trace\030\003"
          + " \001(\0132:.google.cloud.workflows.executions.v1.Execution.StackTrace\"T\n"
          + "\005State\022\025\n"
          ...
          + "LOG_ALL_CALLS\020\001\022\023\n"
          + "\017LOG_ERRORS_ONLY\020\002:\206\001\352A\202\001\n"
          + "+workflowexecutions.googleapis.com/Execution\022Sprojects/{project}/locations/{location}/workflows/{workflow}/executions/{execution}\"\301\001\n"
          ...
          + "\004view\030\004"
          + " \001(\01623.google.cloud.workflows.executions.v1.ExecutionViewB\003\340A\001\"v\n"
          + "\026ListExecutionsResponse\022C\n\n"
          + "executions\030\001"
          + " \003(\0132/.google.cloud.workflows.executions.v1.Execution\022\027\n"
          + "\017next_page_token\030\002 \001(\t\"\234\001\n"
          + "\026CreateExecutionRequest\0229\n"
          + "\006parent\030\001 \001(\tB)\340A\002\372A#\n"
          + "!workflows.googleapis.com/Workflow\022G\n"
          + "\texecution\030\002"
          + " \001(\0132/.google.cloud.workflows.executions.v1.ExecutionB\003\340A\002\"\240\001\n"
          + "\023GetExecutionRequest\022A\n"
          + "\004name\030\001 \001(\tB3\340A\002\372A-\n"
          + "+workflowexecutions.googleapis.com/Execution\022F\n"
          + "\004view\030\002"
          + " \001(\01623.google.cloud.workflows.executions.v1.ExecutionViewB\003\340A\001\"[\n"
          ...
          + "\016ListExecutions\022;.google.cloud.workflows.executions.v1.ListExecutionsRequest\032<.google.cloud.workflows.executions.v1.ListExecutionsResponse\"K\202\323\344\223\002<\022:/v1/{parent=projects/*/locations/*/workflows/*}/executions\332A\006parent\022\342\001\n"
          + "\017CreateExecution\022<.google.cloud.workflows.executions.v"
          + "1.CreateExecutionRequest\032/.google.cloud."
          + "workflows.executions.v1.Execution\"`\202\323\344\223\002"
          + "G\":/v1/{parent=projects/*/locations/*/workflows/*}/executions:"
          + "\texecution\332A\020parent,execution\022\305\001\n"
          + "\014GetExecution\0229.google.cloud.workflows.executions.v1.GetExecutionRequest\032/.google.cloud.workflows.executions.v1.Execution\"I\202\323\344\223\002<\022:/v1/{name=projects/*/locations/*/workflows/*/executions/*}\332A\004name\022\325\001\n"
          + "\017CancelExecution\022<.google.cloud.workflows.executions.v1.CancelExe"
          + "cutionRequest\032/.google.cloud.workflows.executions.v1.Execution\"S\202\323\344\223\002F\"A/v1/{name=projects/*/locations/*/workflows/*/executions/*}:cancel:\001*\332A\004name\032U\312A!workflowexecutions.googleapis.com\322A.https://www.googleapis.com/auth/cloud-platformB\361\001\n"
          ...
          + "!workflows.googleapis.com/Workflow\022<projects/{project}/loc"
          + "ations/{location}/workflows/{workflow}b\006proto3"
    };
    descriptor =
